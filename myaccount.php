            ...
            <div class="main_container">
                ...
                <div class="table-responsive">
                    ...
                    <form action="" method="POST">
                        <div class= search>
                            <input class="search-box" type="text" name="name" placeholder="Enter the Name">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    $records = mysqli_query($con,"select * from org where name = '$name'"); // fetch data from database
                                    ...
                                    $records = mysqli_query($con,"select * from emg where name = '$name'"); // fetch data from database
