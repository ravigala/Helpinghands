         ...
         <section id="contact-section">
           <div class="container">
             ...
             <div class="contact-form">
                  ...
                  <!-- First grid -->
               <div>
                 <a href="google_map.html" class="icon-info"><i class="fa fa-map-marker"></i><span class="form-info">  Mumbai </span><br></a>
                 <a href="#"><i class="fa fa-phone" class="icon-info"> </i><span class="form-info">  9876543210</span><br></a>
                 <a href="#"><i class="fa fa-envelope" class="icon-info"></i><span class="form-info">  helpinghands@gmail.com</span></a>
               </div>
