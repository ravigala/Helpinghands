...
<div class="header">
        <!-- Logo -->
        <nav id="logo"><a class="navbar-brand" href="#"><img src="assets/images/logo.jpeg"> Helping Hands</a></nav>
        <!-- Logo-->
    ...
    <div class="about-us">
        <hr>
        <h1>ABOUT US</h1>
        <p>Helping Hands priorities and objectives are to carry out charitable, holistic and sustainable development work among the poor, marginalized, downtrodden, illiterate, vulnerable and the exploited ones, irrespective of their caste, creed, colour or religion. In achieving the same we work in partnership with other national and international NGOs.The vision of Helping Hands is to create a just, equal and peaceful society where everybody shares and cares for the poor,  unprivileged and exploited people and make the world a better place to live in.This is best done by establishing a redeemed, regenerated and progressive society, which will be free from exploitation, injustice and disparities – where the overall development and dignity of every person will be secured, where people can live in peace, solidarity, co-operation and brotherhood and where the rights of each one will be protected. </p>
        <hr>
    </div>
    ...
    <div class="service-txt">
        ...
        <div class="box" style="width: 350px">
            <img src="../Helping-Hands/assets/images/about-ind.jpg" alt="">
            <h2>Individual</h2>
        ...
        <div class="box">
            <img src="../Helping-Hands/assets/images/about-org.jpg" alt="">
            <h2>Organization</h2>
        ...
        <div class="box">
            <img src="../Helping-Hands/assets/images/about-emr.jpg" alt="">
            <h2>Emergency</h2>
    ...
    <footer>
        <div class="footer">
         ...
         <!-- Copyright -->
         <p class="footer-bottom-text">All Right reserved by &copy;Helping Hands.2021</p>
         <!-- Copyright -->
    </footer>
    <!-- End Footer -->
</body>
