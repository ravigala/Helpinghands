            ...
            <div class="container">
                <form method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                        <input type="text" id="thing1" name="thing1" placeholder="10 shirts" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">          
                        ...
                        <div class="col-75">
                        <input type="text" id="thing2" name="thing2" placeholder="Any other thing">
                        </div>
                    </div>
                    <!-- <div class="row">
                        <div class="col-25">
...
if(isset($_POST['submit'])){
    ...
    $insertquery =" insert into ind(name,email,mobileno,address,city,state,Donatething,thing1,thing2,date) values ('$name','$email','$mobileno','$address','$city','$state','$Donatething','$thing1','$thing2','$date')";
