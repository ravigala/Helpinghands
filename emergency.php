...
if(isset($_POST['submit1'])){
    ...
    $insertquery =" insert into emg(name,email,mobileno,address,city,state,Donatething,thing1,thing2,date) values ('$name','$email','$mobileno','$address','$city','$state','$Donatething','$thing1','$thing2','$date')";
